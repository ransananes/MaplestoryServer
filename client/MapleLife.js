module.exports = class MapleLife {
    constructor() {
        this.x = 0;
        this.y = 0;
        this.foothold = 0;
    ...
    decodeMovePath(reader, preventUpdates) {
        if (!preventUpdates) {
    ...
    encodeMovePath(movePath, writer) {
        writer.writeInt16(this.previousX);
        writer.writeInt16(this.previousY);
